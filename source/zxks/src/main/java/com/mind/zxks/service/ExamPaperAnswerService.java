...
import com.mind.zxks.domain.ExamPaperAnswerInfo;
...
public interface ExamPaperAnswerService extends BaseService<ExamPaperAnswer> {
    ...
    PageInfo<ExamPaperAnswer> adminPage(com.mind.zxks.viewmodel.admin.paper.ExamPaperAnswerPageRequestVM requestVM);
}
